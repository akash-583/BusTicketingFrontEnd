...
isPrint:boolean=false;
  ...
  const imageHTML = '<img src="/assets/Andhra_Pradesh_State_Road_Transport_Corporation_logo.png" alt="Image Description" style="height: 100px;width: 100px;margin-left: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
 const line="<h2 class='text-center'><b>SRTC</b></h2>";
...
window.location.reload();
  ...
  cancelTicket(ticketNo: any) {
    ...
    this.bookingService.cancelTicket(ticketNo).subscribe({
      next: (res) => {
        console.log(res);
      },
    });
  ...
  details(ticketNo: any){
    this.bookingService.getDetails(ticketNo).subscribe({
      next: (res) => {
        this.data=res;
        // console.log("***************************************************")
        console.log(res)
